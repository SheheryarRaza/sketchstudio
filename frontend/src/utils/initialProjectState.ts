...
export const INITIAL_METHODS_STATE: DrawingMethodState = {
  ...
  bargue: {
    points: [
      { id: 'p1', x: 300, y: 140, source: 'fallback' },
      { id: 'p2', x: 450, y: 280, source: 'fallback' },
      { id: 'p3', x: 430, y: 500, source: 'fallback' },
      { id: 'p4', x: 350, y: 600, source: 'fallback' },
      { id: 'p5', x: 250, y: 600, source: 'fallback' },
      { id: 'p6', x: 170, y: 500, source: 'fallback' },
      { id: 'p7', x: 150, y: 280, source: 'fallback' },
    ],
